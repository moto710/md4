...
public interface ICustomerRepository extends JpaRepository<Customer, Integer> {
    ...
    @Query("SELECT NEW com.cg.spbajaxbankingtransactionjwt.model.dto.CustomerDTO (c.id, " +
                                                                        "c.name, " +
                                                                        "c.email, " +
                                                                        "c.phone, " +
                                                                        "c.balance, " +
    ...
    @Query("SELECT NEW com.cg.spbajaxbankingtransactionjwt.model.dto.CustomerDTO (" +
                                                                        "c.id, " +
                                                                        "c.name, " +
                                                                        "c.email, " +
                                                                        "c.phone, " +
